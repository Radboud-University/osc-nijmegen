...
words[words$value == "transparent",] = "transparency"
...
#words[words$value == "shared",] = "sharing"
...
quest_data %>%
      ...
      geom_bar(mapping = aes(fill =  count),
               stat = "identity") +
      geom_text(mapping = aes(label = count), hjust = -0.5, size = 5) +
      theme_classic() +
      ylim(0, 200) +
      coord_flip() +
...
pregiven %>%
        ...
        ggplot() +
        geom_bar(mapping = aes(x = reorder(value, counts), y = counts, fill=counts), 
                 stat = "identity") +
        geom_text(mapping = aes(x= reorder(value, counts), y = counts, label = counts), hjust = -0.5, size = 5) +
        ylim(0, 140) +
        theme_classic() +
        coord_flip() +
        theme(legend.position = "none",
...
tmp %>%
        ...
        geom_bar(mapping = aes(fill = counts),
                 stat = "identity") +
        geom_text(mapping = aes(label = counts), hjust = -0.5, size = 5) +
        ylim(0, 170) +
        theme_classic() +
        coord_flip() +
        theme(legend.position = "none",
